...
import com.github.dungphan.unityindex.handlers.createMatcher
...
import com.github.dungphan.unityindex.tools.models.FindClassResult
...
class FindClassTool : AbstractMcpTool() {
    ...
    private fun createMatcher(pattern: String, matchMode: String = "substring"): MinusculeMatcher =
        com.github.dungphan.unityindex.handlers.createMatcher(pattern, matchMode)
    ...
    private fun createNameFilter(pattern: String, matchMode: String, matcher: MinusculeMatcher): (String) -> Boolean =
        com.github.dungphan.unityindex.handlers.createNameFilter(pattern, matchMode, matcher)
}
